 ...
 */
class OphTrAmdtreatmentnote_PostInjectionTreatmentTreatment extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophtramdtreatmentnote_pit_treatment';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		return OphTrAmdtreatmentnote_pittreatmentOption::model()->findByPk($this->treatment_option_id)->name;
	}
