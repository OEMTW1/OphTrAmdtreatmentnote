 ...
 */
class OphTrAmdtreatmentnote_PreInjectionTreatmentTreatment extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophtramdtreatmentnote_pre_treatment';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		return OphTrAmdtreatmentnote_pretreatmentOption::model()->findByPk($this->treatment_option_id)->name;
	}
