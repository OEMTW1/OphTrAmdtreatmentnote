 ...
 */
class OphTrAmdtreatmentnote_ComplicationComplication extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophtramdtreatmentnote_complication_complication';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		return OphTrAmdtreatmentnote_ComplicationComplicationOption::model()->findByPk($this->complication_option_id)->name;
	}
